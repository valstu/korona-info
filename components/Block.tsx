...
const Block:React.FC<BoxProps & BlockProps> = ({ children, footer, title, extraInfo, ...rest}) => (
  <StyledBox borderRadius={5} background="white" {...rest}>
    ...
    {children}
    {footer && <Box py={5} px={2} m={0} minHeight={60} textAlign="center" background="#f8f9fa" borderTop="solid 1px rgba(102,119,136,.15)" fontFamily="Space Mono" fontSize="0.8em" color="gray.700">{footer} &nbsp;</Box>}
  </StyledBox>
);
